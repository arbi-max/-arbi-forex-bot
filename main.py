...
PAIRS = [
dict(name=“EUR/USD”, kraken=“EURUSD”, pip_val=10),
dict(name=“GBP/USD”, kraken=“GBPUSD”, pip_val=10),
dict(name=“USD/JPY”, kraken=“USDJPY”, pip_val=9),
dict(name=“XAU/USD”, kraken=“XAUUSD”, pip_val=1),
]
...
if jr:
n = jr[0]
return dict(status=2, reason=“News sortie il y a “ + str(abs(n[“mins”])) + “min : “ + n[“title”], action=“Trader la reaction”)
if rh:
n = rh[0]
...
send(“ARBI BOT PRO v6 - “ + now + chr(10) + “Paires : EUR/USD GBP/USD USD/JPY XAU/USD” + chr(10) + “En surveillance…”)
